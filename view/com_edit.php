...
$id=$_GET['id']; 
$req = "SELECT * FROM forum where id=$id";
$res = mysqli_query($con, $req) or die('Requette incorrecte'. $result);
$comnt = mysqli_fetch_array($res);
        ...
        <div class="main_content">
            <div class="container">
                ...
                <nav class="cd-secondary-nav border-b md:m-0 nav-small">
                    <ul>
                        <li ><a href="fourml.php" class="lg:px-2"> Popular </a></li>
                        <li><a href="#" class="lg:px-2"> Featured </a></li>
                        <li><a href="#" class="lg:px-2"> Recent </a></li>
                        <li class="active"><a href="com.php" class="lg:px-2"> ADD </a></li>
                    </ul>
                </nav>
            ...
            <form class="lg:p-10 p-6 space-y-3 relative bg-white shadow-xl rounded-md"   action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                <h1 class="lg:text-2xl text-xl font-semibold mb-6"> Commentaire </h1>
              
                    <input type="hidden" name="user" value="<?= ($comnt[0]); ?>" />
               
                <div>
                    <label class="mb-0" for="username"> Sujet </label>
                    <input type="text"  name="sujet" placeholder="titre" value="<?=$comnt[1]?>" autocomplete="off" class="bg-gray-100 h-12 mt-2 px-3 rounded-md w-full">
                </div>
                
                <div>
                <label class="mb-0" for="username"> Text </label>
                <textarea id="story" name="msg" class="bg-gray-100 h-12 mt-2 px-3 rounded-md w-full"
                 rows="5" cols="33">
                 <?=$comnt[3]?>
                    </textarea>    
                </div>
                ...
                <div>
                    <button type="submit" name="editrep" class="bg-blue-600 font-semibold p-2.5 mt-5 rounded-md text-center text-white w-full">
                        Envoyer</button>
                </div>
