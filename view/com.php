        ...
        <div class="main_content">
            ...
            <form class="lg:p-10 p-6 space-y-3 relative bg-white shadow-xl rounded-md"   action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                <h1 class="lg:text-2xl text-xl font-semibold mb-6"> Commentaire </h1>
                    ...
                    <input type="hidden" name="user" value="<?= ($forlogin[0][0]); ?>" />
               
                <div>
                    <label class="mb-0" for="username"> Sujet </label>
                    <input type="text"  name="sujet" placeholder="titre" autocomplete="off" class="bg-gray-100 h-12 mt-2 px-3 rounded-md w-full">
                </div>
                ...
                <div>
                    <button type="submit" name="add" class="bg-blue-600 font-semibold p-2.5 mt-5 rounded-md text-center text-white w-full">
                        Envoyer</button>
                </div>
